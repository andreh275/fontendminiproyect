...
export default {
  data() {
    return {
      ...
      rows: [
        { user: 'user1', name: 'Producto A', price: 100, quantity: 10, category: 'Alimentos' },
        { user: 'user2', name: 'Producto B', price: 200, quantity: 5, category: 'Electrodomésticos' },
        { user: 'user3', name: 'Producto C', price: 150, quantity: 20, category: 'Familiar' },
        { user: 'user4', name: 'Producto D', price: 80, quantity: 15, category: '+18' }
      ]
    };
  },
  computed: {
  ...
  methods: {
    ...
    loadProducts() {
      console.log(`Productos cargados para la categoría: ${this.selectedCategory}`);
    },
    editProduct(row) {
